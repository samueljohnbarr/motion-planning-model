...
"""
def extractOdom(fileName, odomkeyword, laserkeyword, numOmit, numAfter):
    tvRvSet = []
    numPoints = 2
    #Open file and turn into string
    with open(fileName, 'r') as file:
...
def extractMITData():
    ...
    mitTvRv = extractOdom(file1, 'ODOM', 'ROBOTLASER1', 2, 4)
    mitXy = extractOdom(file1, 'ODOM', 'ROBOTLASER1', 2, 1)
...
def extractCarmenData():
    ...
    carmenTvRv = extractOdom(file2, 'ODOM', 'FLASER', 5, 4)
    carmenXy = extractOdom(file2, 'ODOM', 'FLASER', 5, 1)
...
def extractCarmenData2():
    ...
    carmen2TvRv = extractOdom(file3, 'ODOM', 'FLASER', 2, 4)
    carmenXy = extractOdom(file3, 'ODOM', 'FLASER', 2, 1)
...
def extractBelgData():
    ...
    belgTvRv = extractOdom(file4, 'ODOM', 'FLASER', 4, 4)
    belgXy = extractOdom(file4, 'ODOM', 'FLASER', 4, 1)
